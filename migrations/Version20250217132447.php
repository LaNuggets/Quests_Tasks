 ...
 */
final class Version20250217132447 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE habitude (id INT AUTO_INCREMENT NOT NULL, createur_id INT DEFAULT NULL, groupe_id INT DEFAULT NULL, texte VARCHAR(255) NOT NULL, difficulte VARCHAR(15) NOT NULL, couleur VARCHAR(7) NOT NULL, periodicite VARCHAR(15) NOT NULL, cible VARCHAR(15) NOT NULL, date_creation DATETIME NOT NULL, INDEX IDX_10DD3E5F73A201E5 (createur_id), INDEX IDX_10DD3E5F7A45358C (groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE habitude ADD CONSTRAINT FK_10DD3E5F73A201E5 FOREIGN KEY (createur_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE habitude ADD CONSTRAINT FK_10DD3E5F7A45358C FOREIGN KEY (groupe_id) REFERENCES groupe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE habitude DROP FOREIGN KEY FK_10DD3E5F73A201E5');
        $this->addSql('ALTER TABLE habitude DROP FOREIGN KEY FK_10DD3E5F7A45358C');
